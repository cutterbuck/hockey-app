...
leagues = [{'name': 'NHL'}]
conferences = [{'name': 'Eastern'}, {'name': 'Western'}]
divisions = [{'name': 'Atlantic', 'conference': 'Eastern'}, {'name': 'Metropolitan', 'conference': 'Eastern'}, {'name': 'Central', 'conference': 'Western'}, {'name': 'Pacific', 'conference': 'Western'}]

seasons = [{'name': '2022-23', 'start_date': datetime.date(2022, 10, 7), 'end_date': datetime.date(2023, 4, 14)},
            {'name': '2023-24', 'start_date': datetime.date(2023, 10, 10), 'end_date': datetime.date(2024, 4, 18)},
            {'name': '2024-25', 'start_date': datetime.date(2024, 10, 4), 'end_date': datetime.date(2025, 4, 17)}]


team_colors = {'ANA': {'primary': 'rgb(252,76,2)', 'secondary': 'rgb(176,152,98)'},
